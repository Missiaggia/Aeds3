...
class Filme implements Serializable {
    ...
    public void fromByteArray(byte ba[]) throws Exception {
        ...
        this.ano = formatter.parse(dis.readUTF());
        ...
        this.genero = generoReplace2.split(",");
...
public class TP01 {
    ...
    public static String FileToString(RandomAccessFile arq) throws Exception {
        String resp = "";
        int len = 0;
        byte ba[];
        long posIni = 5;
        ...
        while (true) {
            try {
                ...
                Filme filmeTempo = new Filme();
                filmeTempo.fromByteArray(ba);
                filmeTempo.toString();
                resp += filmeTempo.toString();
    ...
    public static void criaArquivoCesar(String resposta, String nomeArq) throws IOException {
        RandomAccessFile arq = new RandomAccessFile(nomeArq, "rw");
        byte ba[];
        ba = resposta.getBytes();
        arq.write(ba);
        arq.close();
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (choice != 7) {
            ...
            switch (choice) {
                ...
                case 5:
                    System.out.println("\n(Cesar)");
                    RandomAccessFile arq = new RandomAccessFile("./data/Imdb.bin", "rw");
                    FileInputStream arqLer = new FileInputStream("./data/Imdb.bin");
                    ...
                    switch (opcao) {
                        case 1:
                            resp = Cesar.criptografa(FileToString(arq));
                            criaArquivoCesar(resp, "data/CriptografadoCesar.db");
                            break;
                        case 2:
                            resp = lerArq.readUTF();
                            resp = Cesar.descriptografa(Cesar.criptografa(FileToString(arq)));
                            criaArquivoCesar(resp, "data/DescriptografadoCesar.db");
                            break;
                        default:
                            break;
                    }
                ...
                case 6:
                    System.out.println("\nDES");
                    RandomAccessFile Arquivo = new RandomAccessFile("./data/Imdb.bin", "rw");
                    System.out.println("Criptografia e descriptografia usando DES");
                    DES.mostraAlgoritimo(FileToString(Arquivo));
                case 7:
                    // Saindo do programa
